...
public class Servlet_Demo2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_Demo2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_Demo2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       {
           out.println("It is a valid triangle");
           if(a==b && a==c)
               out.println("Equilateral");
           else if(a==b || b==c || c==a)
               out.println("isoslece");
           else 
               out.println("scaline");
       }
       else
       {
           out.println("It is an invalid triangle");
       }
    }
